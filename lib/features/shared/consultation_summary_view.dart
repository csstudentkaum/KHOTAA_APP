...
class ConsultationSummaryView extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<Consultation?>(
        ...
        builder: (context, snapshot) {
          ...
          final hasSummary = c.diagnosis != null ||
              c.notes != null ||
              c.prescription != null;
  ...
  Widget _buildHeader(Consultation c) {
    return Container(
      ...
      child: Column(
        children: [
          _infoRow(Icons.person_outline_rounded, 'Patient',
              c.patientName ?? 'Unknown'),
          const Divider(height: 20, color: AppColors.divider),
          _infoRow(Icons.medical_services_outlined, 'Doctor',
      ...
      child: Column(
        ...
        children: [
          ...
          if (c.followUpTasks.isNotEmpty) ...[
            ...
            ...c.followUpTasks.map((task) => Padding(
