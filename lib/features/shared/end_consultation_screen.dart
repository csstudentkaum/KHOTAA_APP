  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (_decision == 'complete') {
        ...
        await NotificationService().notifyPatientBookingCompleted(
          patientID: widget.consultation.patientID,
          doctorName: widget.consultation.doctorName ?? 'Your doctor',
          consultationID: widget.consultation.consultationID,
        );
      } else {
        ...
        // Notify patient about the follow-up assignment
        await NotificationService().notifyPatientFollowUpStarted(
          patientID: widget.consultation.patientID,
          doctorName: widget.consultation.doctorName ?? 'Your doctor',
          followUpDays: _followUpDays,
          consultationID: widget.consultation.consultationID,
                    ...
                    _buildSectionCard(
                      ...
                      children: [
                        ...
                        _buildTextArea(
                          ...
                          hint:
                              'e.g., Wound care instructions, activity limitations...',
                          maxLines: 3,
                        ),
                      ],
                    ),
