          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Medications
                _buildSectionHeader(Icons.medication_rounded, 'Medications'),
                const SizedBox(height: 10),
                if (plan.medications.isEmpty)
                  _emptyField('No medications prescribed')
                else
                  ...plan.medications.asMap().entries.map(
                    (entry) => _buildMedicationCard(entry.key + 1, entry.value),
                  ),
                const SizedBox(height: 16),
  ...
  Widget _statusBadge(String status) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: (isActive ? AppColors.primary : AppColors.success).withValues(
          alpha: 0.1,
        ),
