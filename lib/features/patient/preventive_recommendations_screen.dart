...
class _PreventiveRecommendationsScreenState
  ...
  void _loadRecommendations() {
    ...
    final healthAlerts = AlertService().alerts
  ...
  RecommendationItem _alertToRecommendation(alert_model.SmartAlert alert) {
    return RecommendationItem(
      ...
      instructions:
          alert.instructions ?? _getDefaultInstructions(alert.category),
    );
  }
  ...
  Widget _buildProgressSummary() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF64ADB3).withOpacity(0.3),
            blurRadius: 12,
  ...
  Widget _buildFilterChips() {
    final unreadCount = _recommendations
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final displayText = filter == 'Unread'
              ? 'Unread ($unreadCount)'
              : filter;
          return FilterChip(
            label: Text(
  ...
  void _showInfoDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Row(
          children: [
            Icon(Icons.info_outline, color: Color(0xFF64ADB3)),
            SizedBox(width: 12),
  ...
  Widget _buildCompleteButton() {
    return GestureDetector(
      ...
      child: Container(
        ...
        height: 44,
        decoration: BoxDecoration(
          color: item.isCompleted ? const Color(0xFF66BB6A) : Colors.grey[100],
