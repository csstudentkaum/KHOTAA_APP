...
class _WeeklyReportScreenState extends State<WeeklyReportScreen> {
  ...
  final List<double> _temperatureData = [32.1, 32.5, 33.2, 32.8, 34.1, 33.5, 32.9];
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 12),
                Text(
                  _isDownloading ? 'Generating PDF...' : 'Download Weekly Report (PDF)',
                  style: const TextStyle(
                    color: Colors.white,
                    fontSize: 17,
                    fontWeight: FontWeight.bold,
  ...
  Future<void> _handleDownload() async {
    ...
    try {
        ...
        pw.MultiPage(
          ...
          build: (pw.Context context) => [
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Row(
                    ...
                    children: [
                      _buildPdfMetric('Avg Temperature', '${_avgTemperature.toStringAsFixed(1)}°C'),
            ...
            pw.Table.fromTextArray(
              ...
              cellHeight: 30,
              headers: _weekDays,
              data: [_temperatureData.map((t) => t.toStringAsFixed(1)).toList()],
            ),
            pw.SizedBox(height: 24),
      ...
      final fileName = 'KHOTAA_Weekly_Report_${DateTime.now().millisecondsSinceEpoch}.pdf';
...
class _SimpleChartPainter extends CustomPainter {
  ...
  void _drawXAxisLabels(Canvas canvas, Size size, double chartWidth, double chartHeight) {
