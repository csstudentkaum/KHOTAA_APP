...
class _MedicalFaqChatbotScreenState extends State<MedicalFaqChatbotScreen> {
  ...
  void _onCategoryTap(String category) {
    setState(() {
      ...
      _messages.add(_ChatMessage(
        text: 'Here are common questions about $category in diabetic foot '
  ...
  void _onBackToTopics() {
    setState(() {
      ...
      _messages.add(const _ChatMessage(
        text: 'Choose another topic below.',
        isBot: true,
      ));
    });
    _scrollToBottom();
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Icon(Icons.open_in_new,
                              size: 11, color: _kTeal.withOpacity(0.6)),
                        ],
                      ),
                    ),
                  ),
      ...
      children: [
        GestureDetector(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Icon(Icons.arrow_back_ios, size: 14, color: _kTeal),
                const SizedBox(width: 4),
                Text(
                  'All Topics',
                  style: TextStyle(
