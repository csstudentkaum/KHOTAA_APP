...
class AnalysisResultScreen extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          ...List.generate(bullets.length, (i) {
            ...
            final isConsult =
                bullets[i].toLowerCase().contains('consultation');
  ...
  Widget _buildDoctorAlertCard(BuildContext context) {
    ...
    final alertColor =
        isCritical ? const Color(0xFFE53935) : const Color(0xFFE67E22);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: alertColor.withValues(alpha: 0.25), width: 1.2),
          boxShadow: [
            BoxShadow(
              color: alertColor.withValues(alpha: 0.06),
              blurRadius: 8,
      ...
      child: Row(
        ...
        children: [
          const Icon(Icons.info_outline_rounded,
              size: 18, color: Color(0xFF7B8D9E)),
    ...
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
          ...
          elevation: 3,
          shadowColor: _kDarkBlue.withValues(alpha: 0.3),
          shape:
        ...
        pw.MultiPage(
          ...
          build: (ctx) => [
            ...
            pw.Row(
              mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
              children: [
                pw.Text('Date: $_formattedDate',
                    style: const pw.TextStyle(fontSize: 11)),
                pw.Text('Model: ${analysis.modelName}',
                    style: const pw.TextStyle(fontSize: 11)),
              ],
            ),
            ...
            pw.Center(
              child: pw.ClipRRect(
                horizontalRadius: 8,
                verticalRadius: 8,
                child: pw.Image(pdfImage, width: 220, height: 180,
                    fit: pw.BoxFit.cover),
              ),
            ),
            ...
            pw.Container(
              ...
              child: pw.Column(
                children: [
                  pw.Text('Classification: ${analysis.classificationLabel}',
                      style: pw.TextStyle(
                          fontSize: 18,
                          fontWeight: pw.FontWeight.bold,
                          color: riskPdfColor)),
            ...
            // What This Means
            pw.Text('What This Means',
                style: pw.TextStyle(
                    fontSize: 14, fontWeight: pw.FontWeight.bold)),
            pw.SizedBox(height: 6),
            pw.Text(analysis.patientSummary,
            ...
            pw.Text('Recommendations',
                style: pw.TextStyle(
                    fontSize: 14, fontWeight: pw.FontWeight.bold)),
            pw.SizedBox(height: 6),
            pw.Text(analysis.recommendation,
                style: const pw.TextStyle(fontSize: 11, lineSpacing: 4)),
            pw.SizedBox(height: 16),
