...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  /// Validate card fields, create the booking in Firestore, then navigate to success.
  Future<void> _onPayNow() async {
    // ── Basic field validation ──
    final cardDigits = _cardController.text.replaceAll(RegExp(r'\s'), '');
    ...
    try {
      ...
      if (user == null) {
        _showError('Please log in to complete payment.');
        return;
      }
      ...
      await _consultationService.createConsultation(
        ...
        consultationDate: widget.selectedDate,
        timeSlot: widget.time,
      );

      if (mounted) {
        // Navigate to success screen and remove Payment + SelectDateTime from stack
                ...
                children: [
                  ...
                  CupertinoButton(
                    ...
                    onPressed: () {
                      ...
                      final yy = (selectedYear % 100).toString().padLeft(
                        2,
                        '0',
                      );
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _summaryRow(Icons.person, widget.doctorName),
                        ...
                        if (widget.time.isNotEmpty) ...[
                          const SizedBox(height: 8),
                          _summaryRow(Icons.access_time, widget.time),
                        ],
                      ],
                    ),
                  ),
